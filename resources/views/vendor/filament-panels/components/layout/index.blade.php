{{--
    Override of filament/filament v3.3.54's components/layout/index.blade.php
    — identical except the sidebar-scroll-into-view <script> now carries
    @nonce. See base.blade.php in this same directory for the full
