{{--
    Override of filament/filament v3.3.54's components/sidebar/index.blade.php
    — identical except the collapsed-groups <script> now carries @nonce.
    See ../layout/base.blade.php for the full explanation. Re-diff on any
    filament/filament upgrade.
--}}
@props([
    'navigation',
])
